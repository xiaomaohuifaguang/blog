import{_ as c,r as o,o as d,c as r,a as n,e,w as i,b as s,d as t}from"./app-c3071a03.js";const u={},p=t('<h1 id="docker安装部署" tabindex="-1"><a class="header-anchor" href="#docker安装部署" aria-hidden="true">#</a> docker安装部署</h1><div class="hint-container tip"><p class="hint-container-title">摘要</p><p>docker安装部署<br> 推荐使用具有管理员权限的普通账户安装</p></div><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录" aria-hidden="true">#</a> 目录</h1>',3),m={class:"table-of-contents"},v=n("h2",{id:"官网",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#官网","aria-hidden":"true"},"#"),s(" 官网")],-1),k={href:"https://docs.docker.com/",target:"_blank",rel:"noopener noreferrer"},b=n("h2",{id:"centos",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#centos","aria-hidden":"true"},"#"),s(" centos")],-1),h={href:"https://docs.docker.com/engine/install/centos/",target:"_blank",rel:"noopener noreferrer"},f=n("li",null,"建议用有管理员权限的用户操作 建议不要直接用root",-1),_=n("li",null,"安装过程",-1),g=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 卸载旧版本旧版本的Docker被命名为dockerordocker-engine，</span>
