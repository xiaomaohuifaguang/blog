import{_ as e,r as i,o as t,c,a as n,b as l,e as p,d as s}from"./app-1045305f.js";const r={},o=s(`<h1 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> docker</h1><div class="hint-container tip"><p class="hint-container-title">摘要</p><p>docker 使用记录</p></div><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 参考 https://www.runoob.com/docker/centos-docker-install.html  </span>
