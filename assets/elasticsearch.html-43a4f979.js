import{_ as t,r as i,o as r,c as o,a as s,b as n,e as a,w as p,d as c}from"./app-1045305f.js";const d={},m=c('<h1 id="elasticsearch" tabindex="-1"><a class="header-anchor" href="#elasticsearch" aria-hidden="true">#</a> elasticsearch</h1><div class="hint-container tip"><p class="hint-container-title">摘要</p><p>elasticsearch 使用记录</p></div><h2 id="网址" tabindex="-1"><a class="header-anchor" href="#网址" aria-hidden="true">#</a> 网址</h2>',3),v={href:"https://www.elastic.co/cn/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://github.com/medcl/elasticsearch-analysis-ik/releases",target:"_blank",rel:"noopener noreferrer"},u=c(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="centos-docker" tabindex="-1"><a class="header-anchor" href="#centos-docker" aria-hidden="true">#</a> centos docker</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># docker hub 查看 镜像 </span>
