import{_ as e,r as t,o as i,c as l,a as n,b as o,e as c,d as s}from"./app-1045305f.js";const p={},r=s('<h1 id="node-js" tabindex="-1"><a class="header-anchor" href="#node-js" aria-hidden="true">#</a> Node.js</h1><div class="hint-container tip"><p class="hint-container-title">摘要</p><p>Node.js 使用记录</p></div><h2 id="下载地址" tabindex="-1"><a class="header-anchor" href="#下载地址" aria-hidden="true">#</a> 下载地址</h2>',3),d={href:"https://nodejs.org/en",target:"_blank",rel:"noopener noreferrer"},m=s(`<h2 id="windows" tabindex="-1"><a class="header-anchor" href="#windows" aria-hidden="true">#</a> windows</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 验证</span>
