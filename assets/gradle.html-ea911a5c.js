import{_ as t,r as e,o as i,c as p,a as n,b as o,e as l,d as s}from"./app-1045305f.js";const c={},u=s('<h1 id="gradle" tabindex="-1"><a class="header-anchor" href="#gradle" aria-hidden="true">#</a> Gradle</h1><div class="hint-container tip"><p class="hint-container-title">摘要</p><p>Gradle 使用记录</p></div><h2 id="下载地址" tabindex="-1"><a class="header-anchor" href="#下载地址" aria-hidden="true">#</a> 下载地址</h2>',3),r={href:"https://gradle.org/releases/",target:"_blank",rel:"noopener noreferrer"},d=s(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 添加环境变量</span>
